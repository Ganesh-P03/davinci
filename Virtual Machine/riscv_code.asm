...
// *** Call Sys.init ***
// Call Memory.main 0
lui $t0, Memory.main$ret.1
addi $t0, $t0, Memory.main$ret.1
add $t0, $t0, $pc
sw $t0, 0($sp)
addi $sp, $sp, 4
...
lui $t0, Memory.bestFit$ret.3
addi $t0, $t0, Memory.bestFit$ret.3
add $t0, $t0, $pc
sw $t0, 0($sp)
addi $sp, $sp, 4
