...
class CompilationEngine:
    ...
    def compile_class_var_dec(self):
        ...
        if tk.token_type() != "IDENTIFIER":
            raise SyntaxError("{} is not a valid Jack identifier".format(tk.curr_token))
        ...
        while tk.curr_token != ";":
            ...
            if tk.token_type() != "IDENTIFIER":
                raise SyntaxError(
                    "{} is not a valid Jack identifer.".format(tk.curr_token)
                )
            self.symbol_table.define(tk.curr_token, _type, cat)
            tk.advance()
    ...
    def compile_subroutine(self):
        ...
        if tk.token_type() != "IDENTIFIER":
            raise SyntaxError(
                "Subroutine name ({}) not a valid identifier".format(tk.curr_token)
            )
    ...
    def compile_var_dec(self):
        ...
        if tk.token_type() != "IDENTIFIER":
            raise SyntaxError("{} is not a valid Jack identifer.".format(tk.curr_token))
        self.symbol_table.define(tk.curr_token, _type, cat)
        tk.advance()
    ...
    def compile_do_statement(self):
        ...
        if tk.token_type() != "IDENTIFIER":
            raise SyntaxError("{} is not a proper identifier.".format(tk.curr_token))
    ...
    def compile_term(self):
        ...
        if tk.token_type() == "STRING_CONST":
            ...
            if tk.token_type() != "IDENTIFIER":
                raise SyntaxError("{} is not a valid identifier.".format(tk.curr_token))
            var_name = tk.curr_token
            tk.advance()
            if tk.curr_token == "[":
                tk.advance()  # "["
