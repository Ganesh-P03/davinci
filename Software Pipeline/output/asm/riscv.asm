...
addi $t0, $t0, Math.twoToThe$ret.350
add $t0, $t0, $pc
sw $t0, 0($sp)
addi $sp, $sp, 4
sw $lcl, 0($sp)
...
addi $t0, $t0, Math.multiply$ret.353
add $t0, $t0, $pc
sw $t0, 0($sp)
addi $sp, $sp, 4
sw $lcl, 0($sp)
...
sw $t0, 0($sp)
addi $sp, $sp, 4
lui $t0, Math.twoToThe$ret.358
addi $t0, $t0, Math.twoToThe$ret.358
add $t0, $t0, $pc
sw $t0, 0($sp)
addi $sp, $sp, 4
sw $lcl, 0($sp)
...
addi $t0, $t0, Output.moveCursor$ret.380
add $t0, $t0, $pc
sw $t0, 0($sp)
addi $sp, $sp, 4
sw $lcl, 0($sp)
...
addi $t0, $t0, Math.multiply$ret.382
add $t0, $t0, $pc
sw $t0, 0($sp)
addi $sp, $sp, 4
sw $lcl, 0($sp)
...
sw $t0, 0($sp)
addi $sp, $sp, 4
lui $t0, Math.multiply$ret.385
addi $t0, $t0, Math.multiply$ret.385
add $t0, $t0, $pc
sw $t0, 0($sp)
addi $sp, $sp, 4
sw $lcl, 0($sp)
...
addi $t0, $t0, Math.twoToThe$ret.390
add $t0, $t0, $pc
sw $t0, 0($sp)
addi $sp, $sp, 4
sw $lcl, 0($sp)
