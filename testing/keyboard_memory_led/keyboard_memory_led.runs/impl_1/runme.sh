...
HD_PWD='D:/semester/7th sem/davinci/testing/keyboard_memory_led/keyboard_memory_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log keyboard_driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source keyboard_driver.tcl -notrace
