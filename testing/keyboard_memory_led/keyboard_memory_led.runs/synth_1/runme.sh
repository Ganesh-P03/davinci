...
HD_PWD='D:/semester/7th sem/davinci/testing/keyboard_memory_led/keyboard_memory_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log keyboard_driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source keyboard_driver.tcl
